...
type ParseTarget = HashMap<usize, i64>;
type Solution = i64;

const EXAMPLES: [(&str, usize, Solution); 3] = [
    ("1", 18, 26),
    ("1", 80, 5934),
    ("1", 256, 26984457539)
];
...
fn main() {
    ...
    println!(
        "{}",
        operation(256, format!("{}/input", DAY)).expect("Unexpected Error in main input.")
    );
}
...
fn next_day(curr: HashMap<usize, i64>) -> HashMap<usize, i64> {
